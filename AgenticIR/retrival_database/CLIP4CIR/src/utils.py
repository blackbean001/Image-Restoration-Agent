...
from data_utils import CIRRDataset, FashionIQDataset, ImgResDataset
...
def extract_index_features(dataset: Union[CIRRDataset, FashionIQDataset, ImgResDataset], clip_model: CLIP) -> \
    ...
    elif isinstance(dataset, ImgResDataset):
        print(f"extracting ImgRes {dataset.split} index features")
