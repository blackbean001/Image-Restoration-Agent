...
input_dir = Path("/home/jason/AgenticIR/dataset/train").resolve()
root_output_dir = Path("/home/jason/AgenticIR/exhaustive_sequences").resolve()
print("dirs: ", input_dir, root_output_dir)
...
deg_dirs = sorted_glob(input_dir, f"*")
print("deg_dirs: ", deg_dirs)
deg_dir = deg_dirs[idx]
print("deg_dir: ", deg_dir)
