...
port = cfg["motion_deblurring"]["Restormer"]["port"]
host = cfg["motion_deblurring"]["Restormer"]["host"]
weight_dir = os.path.join(root_dir, cfg["motion_deblurring"]["Restormer"]["weight_dir"])
