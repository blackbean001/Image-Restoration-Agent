...
class VectorQuantizer(nn.Module):
    ...
    def __init__(self, n_e, e_dim, weight_path='/home/jason/AgenticIR/executor/dehazing/tools/RIDCP_dehazing/pretrained_models/weight_for_matching_dehazing_Flickr.pth', beta=0.25, LQ_stage=False, use_weight=True, weight_alpha=1.0):
        super().__init__()
        self.n_e = int(n_e)
