...
wget https://huggingface.co/lxq007/DiffBIR-v2/resolve/main/codeformer_swinir.ckpt
wget https://huggingface.co/mykh-med/face-enchacer/resolve/main/general_swinir_v1.ckpt
